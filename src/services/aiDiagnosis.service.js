...
// export const predictBloodPressure = async (measurements) => {
//   try {
//     const response = await axios.post('https://Alzahraa5-blood-pressure.hf.space/predict/', { measurements });
...
// export const predictHeart = async (measurements) => {
//   try {
//     const response = await axios.post('https://Alzahraa5-heart.hf.space/predict', { measurements });
//     return response.data.result;
//   } catch (error) {
